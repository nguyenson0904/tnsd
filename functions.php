...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('countdown', get_template_directory_uri() . '/js/jquery.downCount.js', array('jquery'), '1.0.0'); // Custom scripts
...
// Create Shortcode countdown
// Use the shortcode: [countdown]
function create_countdown_shortcode($atts) {
	// Attributes
	$atts = shortcode_atts(
		array(
		),
...
<li> <span class="number hours">00</span>
<p class="text hours_ref">Giờ</p>
</li>

<li> <span class="number minutes">00</span>
<p class="text minutes_ref">Phút</p>
</li>

<li> <span class="number seconds">00</span>
<p class="text seconds_ref">Giây</p>
</li>
</ul>
<?php    return ob_get_clean();
}
add_shortcode( 'countdown', 'create_countdown_shortcode' );

// Create Shortcode formdangky
// Use the shortcode: [formdangky]
...
//
function create_formquatang_shortcode($atts) {
	// Attributes
	$atts = shortcode_atts(
		array(
		),
	...
	// Attributes in var
ob_start();?>
	<form id="formquatang"  action="" method="POST" target="no-target">
    <input type="text" id="gemail" name="" value="" placeholder="Nhập email của bạn vào đây">
    <button id="gform-submit" class="" type="submit">ĐĂNG KÝ NGAY</button>
  </form>
  <p id="input-feedback"></p>
  <!-- <iframe src="#" id="no-target-2" name="no-target" style="visibility:hidden;height:0;"></iframe> -->

	<?php    return ob_get_clean();
}
add_shortcode( 'formquatang', 'create_formquatang_shortcode' );
